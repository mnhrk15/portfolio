...
export const projectsData: Project[] = [
  {
    id: 1,
    title: "HotPepperBeautyブログ自動生成・投稿アプリ",
    shortDescription: "HotPepperBeautyブログ記事の自動生成・投稿を実現し、コンテンツ作成を効率化。",
    mainImage: "/images/projects/blog-automation_main.png",
    techIcons: ["Python", "Flask", "Playwright", "Requests", "BeautifulSoup", "Google Gemini API", "Docker"],
  ...
  },
  {
    ...
    techIcons: ["Python", "Flask", "Google Gemini API", "FLUX.1 Kontext API", "Celery", "Redis", "Pillow", "Docker"],
  ...
  },
  {
    ...
    techIcons: ["Python", "Flask", "Pandas", "Numpy", "Chat.js"],
