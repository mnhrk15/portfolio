...
export const projectsData: Project[] = [
  {
    ...
    mainImage: "/images/placeholder-600x400.png",
    ...
    screenshots: [
      { src: "/images/placeholder-600x400.png", caption: "システムの基本フロー" },
      { src: "/images/placeholder-600x400.png", caption: "生成された記事のサンプル" },
      { src: "/images/placeholder-600x400.png", caption: "投稿設定画面" },
    ],
  ...
  },
  {
    ...
    screenshots: [
      { src: "/images/placeholder-600x400.png", caption: "アプリのメイン画面" },
      { src: "/images/placeholder-600x400.png", caption: "画像から情報が生成される様子" },
    ],
  ...
  },
  {
    ...
    screenshots: [
      { src: "/images/placeholder-600x400.png", caption: "自動投稿プロセスの概念図" },
    ],
  ...
  },
  {
    ...
    description: "大学の研究として、深層学習（LSTM）を用いて、監視カメラ映像などから検出された多数の歩行者の将来の軌道を予測するアルゴリズムを開発しました。自動運転やロボットのナビゲーションへの応用を目的としています。",
     screenshots: [
      { src: "/images/placeholder-600x400.png", caption: "軌道予測結果の可視化" },
      { src: "/images/placeholder-600x400.png", caption: "モデルの構造図" },
    ],
